Shader "AllIn13DShader - Baked Effects/AllIn13DShader - Baked Effects_MAT_Baked_TreeBarkMaterial"
{
	Properties
	{
...
#define _HEIGHT_GRADIENT_ON
#define _HEIGHTGRADIENTPOSITIONSPACE_LOCAL
