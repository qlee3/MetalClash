Shader "AllIn13DShader - Baked Effects/AllIn13DShader - Baked Effects_MAT_Baked_SpitterDither"
{
	Properties
	{
...
#define _FADE_BY_CAM_DISTANCE_ON
#define _FADE_BY_CAM_DISTANCE_NEAR_FADE
#define _DITHER_ON
