Shader "AllIn13DShader - Baked Effects/AllIn13DShader - Baked Effects_MAT_Baked_StatueDistortion"
{
	Properties
	{
...
#define _EMISSION_ON
#define _TEXTURE_BLENDING_ON
#define _TEXTUREBLENDINGSOURCE_TEXTURE
#define _TEXTUREBLENDINGMODE_RGB
#define _ALPHA_CUTOFF_ON
#define _FADE_ON
#define _FADE_BURN_ON
#define _VERTEX_DISTORTION_ON
			...
			#include "../../../Shaders/ShaderLibrary/AllIn13DShader_FragmentEffects.hlsl"
#include "../../../Shaders/ShaderLibrary/AllIn13DShader_AlphaEffects.hlsl"
#include "../../../Shaders/ShaderLibrary/AllIn13DShader_VertexEffects.hlsl"
