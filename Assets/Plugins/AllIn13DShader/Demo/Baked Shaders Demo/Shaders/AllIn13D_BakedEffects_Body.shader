Shader "AllIn13DShader - Baked Effects/AllIn13DShader - Baked Effects_Body"
{
	Properties
	{
...
#define _COLOR_RAMP_ON
#define _COLORRAMPLIGHTINGSTAGE_BEFORELIGHTING
#define _AOMAP_ON
...
#define _RECALCULATE_NORMALS_ON
