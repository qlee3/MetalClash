Shader "AllIn13DShader - Baked Effects/AllIn13DShader - Baked Effects_MAT_Baked_ScreenspaceMapping"
{
	Properties
	{
...
#define _RIMLIGHTINGSTAGE_BEFORELIGHTINGLAST
#define _HUE_SHIFT_ON
#define _CONTRAST_BRIGHTNESS_ON
#define _SCROLL_TEXTURE_ON
#define _SCREEN_SPACE_UV_ON
#define _WAVE_UV_ON
#define _UV_DISTORTION_ON
...
#include "../../../Shaders/ShaderLibrary/AllIn13DShader_UVEffects.hlsl"
